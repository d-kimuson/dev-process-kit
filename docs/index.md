...
| Entry                                                                                                                                                                                                            | Use it when                                                                           |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| `templates/prototype.js` / `templates/usm.js` / `templates/event-storming.js` / `templates/example-mapping.js` / `templates/grill.js` / `templates/plain.js` / `templates/slides.js` / `templates/task-board.js` | the page is that template (`plain`: none of the others fits — header and review only) |
